...
//  private int useDisk;
  ...
  public HMertCore(String configFileName)
  {
    EvaluationMetric.set_knownMetrics();
...
*/
      ...
      try {
        ...
        HDecoder sd = new HDecoder();
        String configFileName = "F:/java_work/Git/mert/zmert_ex/SDecoder_cfg.txt";
        String cmd1 = "F:/java_work/Git/mert/zmert_ex/src.txt";
        String outputFileName = "F:/java_work/Git/mert/zmert_ex/nbest.out";
        sd.process(configFileName, cmd1, outputFileName);
...
//    println("",4);
  ...
  public void main_text(String[] args){
	    HMertCore DMC = new HMertCore(); // dummy MertCore object
...
//	    int currIteration = Integer.parseInt(args[2]);
	    String configFileName = "F:/java_work/Git/mert/zmert_ex/ZMERT_cfg.txt";
...
class HStreamGobbler extends Thread {
	InputStream istream;
	boolean verbose;
	
	HStreamGobbler(InputStream is, int p) {
		istream = is;
		verbose = (p != 0);
	}
